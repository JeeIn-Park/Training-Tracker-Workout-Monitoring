...
//    }
    ...
    private fun loadDefaultMuscles(): List<Muscle> {
        ...
        return listOf(
            // TODO : extract string and make multiple language available
            Muscle(uniqueUUID(), null, 0, "Neck / Traps", listOf("muscle_front_neck_traps", "muscle_back_neck_traps")),
            Muscle(uniqueUUID(), null, 0, "Shoulder", listOf("muscle_front_shoulder", "muscle_back_shoulder")),
            Muscle(uniqueUUID(), null, 0, "Chest", listOf("muscle_front_chest")),
            Muscle(uniqueUUID(), null, 0, "Arm", listOf("muscle_front_biceps", "muscle_back_triceps", "muscle_front_forearm", "muscle_back_forearm")),
            Muscle(uniqueUUID(), null, 0, "Biceps", listOf("muscle_front_biceps")),
            Muscle(uniqueUUID(), null, 0, "Triceps", listOf("muscle_back_triceps")),
            Muscle(uniqueUUID(), null, 0, "Forearms", listOf("muscle_front_forearm", "muscle_back_forearm")),
            Muscle(uniqueUUID(), null, 0, "Abs", listOf("muscle_front_abs")),
