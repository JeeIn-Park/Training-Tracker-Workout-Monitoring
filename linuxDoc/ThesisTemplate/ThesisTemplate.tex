...
\documentclass[ oneside,% the name of the author
                ...
                % the dissertation    title (which cannot be blank)
                     title={Visualised working out traking application \\ With a Second Line Added to the Title},
...
sections, described in what follows.  
However, it is hard and perhaps even 
