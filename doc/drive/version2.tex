...
rather than only enable card management at status fragment, using long click to delete cards - home, long clickable
...
: rather than clicking delete button, can delete it by long click
exercise card item layout changed
batter card design : more aesthetically pleasing app
scroll bar : for better consistent design
card text change


% Setting Fragment 
change status and setting layout : still displaying the version, but added button for further functionalities implementation
...
% preparing for other functionalities
